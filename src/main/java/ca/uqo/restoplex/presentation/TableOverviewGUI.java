	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		if(table2 != null) {
			table2.setOnAction(event -> {
				try {
					OrderTakerGUI.switchToMenuCommande(event, tableList.get(1));
				} catch (IOException e) {
					System.err.println(e.getMessage());
					System.exit(1);
					return;
		...
		if(table3 != null) {
			table3.setOnAction(event -> {
				try {
					OrderTakerGUI.switchToMenuCommande(event, tableList.get(2));
				} catch (IOException e) {
					System.err.println(e.getMessage());
					System.exit(1);
					return;
		...
		if(table4 != null) {
			table4.setOnAction(event -> {
				try {
					OrderTakerGUI.switchToMenuCommande(event, tableList.get(3));
				} catch (IOException e) {
					System.err.println(e.getMessage());
					System.exit(1);
					return;
		...
		if(table5 != null) {
			table5.setOnAction(event -> {
				try {
					OrderTakerGUI.switchToMenuCommande(event, tableList.get(4));
				} catch (IOException e) {
					System.err.println(e.getMessage());
					System.exit(1);
					return;
		...
		if(table6 != null) {
			table6.setOnAction(event -> {
				try {
					OrderTakerGUI.switchToMenuCommande(event, tableList.get(5));
				} catch (IOException e) {
					System.err.println(e.getMessage());
					System.exit(1);
					return;
		...
		if(table7 != null) {
			table7.setOnAction(event -> {
				try {
					OrderTakerGUI.switchToMenuCommande(event, tableList.get(6));
				} catch (IOException e) {
					System.err.println(e.getMessage());
					System.exit(1);
					return;
		...
		if(table8 != null) {
			table8.setOnAction(event -> {
				try {
					OrderTakerGUI.switchToMenuCommande(event, tableList.get(7));
				} catch (IOException e) {
					System.err.println(e.getMessage());
					System.exit(1);
					return;
		...
		if(table9 != null) {
			table9.setOnAction(event -> {
				try {
					OrderTakerGUI.switchToMenuCommande(event, tableList.get(8));
				} catch (IOException e) {
					System.err.println(e.getMessage());
					System.exit(1);
					return;
		...
		if(table10 != null) {
			table10.setOnAction(event -> {
				try {
					OrderTakerGUI.switchToMenuCommande(event, tableList.get(9));
				} catch (IOException e) {
					System.err.println(e.getMessage());
					System.exit(1);
					return;
		...
		if(table11 != null) {
			table11.setOnAction(event -> {
				try {
					OrderTakerGUI.switchToMenuCommande(event, tableList.get(10));
				} catch (IOException e) {
					System.err.println(e.getMessage());
					System.exit(1);
					return;
		...
		if(table12 != null) {
			table12.setOnAction(event -> {
				try {
					OrderTakerGUI.switchToMenuCommande(event, tableList.get(11));
				} catch (IOException e) {
					System.err.println(e.getMessage());
					System.exit(1);
					return;
		...
		if(table13 != null) {
			table13.setOnAction(event -> {
				try {
					OrderTakerGUI.switchToMenuCommande(event, tableList.get(12));
				} catch (IOException e) {
					System.err.println(e.getMessage());
					System.exit(1);
					return;
		...
		if(table14 != null) {
			table14.setOnAction(event -> {
				try {
					OrderTakerGUI.switchToMenuCommande(event, tableList.get(13));
				} catch (IOException e) {
					System.err.println(e.getMessage());
					System.exit(1);
					return;
		...
		if(table15 != null) {
			table15.setOnAction(event -> {
				try {
					OrderTakerGUI.switchToMenuCommande(event, tableList.get(14));
				} catch (IOException e) {
					System.err.println(e.getMessage());
					System.exit(1);
					return;
		...
		if(table16 != null) {
			table16.setOnAction(event -> {
				try {
					OrderTakerGUI.switchToMenuCommande(event, tableList.get(15));
				} catch (IOException e) {
					System.err.println(e.getMessage());
					System.exit(1);
					return;
		...
		if(table17 != null) {
			table17.setOnAction(event -> {
				try {
					OrderTakerGUI.switchToMenuCommande(event, tableList.get(16));
				} catch (IOException e) {
					System.err.println(e.getMessage());
					System.exit(1);
					return;
		...
		if(table18 != null) {
			table18.setOnAction(event -> {
				try {
					OrderTakerGUI.switchToMenuCommande(event, tableList.get(17));
				} catch (IOException e) {
					System.err.println(e.getMessage());
					System.exit(1);
					return;
		...
		if(table19 != null) {
			table19.setOnAction(event -> {
				try {
					OrderTakerGUI.switchToMenuCommande(event, tableList.get(18));
				} catch (IOException e) {
					System.err.println(e.getMessage());
					System.exit(1);
					return;
		...
		if(table20 != null) {
			table20.setOnAction(event -> {
				try {
					OrderTakerGUI.switchToMenuCommande(event, tableList.get(19));
				} catch (IOException e) {
					System.err.println(e.getMessage());
					System.exit(1);
					return;
		...
		if(table21 != null) {
			table21.setOnAction(event -> {
				try {
					OrderTakerGUI.switchToMenuCommande(event, tableList.get(20));
				} catch (IOException e) {
					System.err.println(e.getMessage());
					System.exit(1);
					return;
		...
		if(table22 != null) {
			table22.setOnAction(event -> {
				try {
					OrderTakerGUI.switchToMenuCommande(event, tableList.get(21));
				} catch (IOException e) {
					System.err.println(e.getMessage());
					System.exit(1);
					return;
		...
		if(table23 != null) {
			table23.setOnAction(event -> {
				try {
					OrderTakerGUI.switchToMenuCommande(event, tableList.get(22));
				} catch (IOException e) {
					System.err.println(e.getMessage());
					System.exit(1);
					return;
		...
		if(table24 != null) {
			table24.setOnAction(event -> {
				try {
					OrderTakerGUI.switchToMenuCommande(event, tableList.get(23));
				} catch (IOException e) {
					System.err.println(e.getMessage());
					System.exit(1);
					return;
